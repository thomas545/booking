...
class BaseNestedModelSerializer(serializers.ModelSerializer):
    ...
    def update_or_create_reverse_relations(self, instance, reverse_relations):
        ...
        for (
            field_name,
            (related_field, field, field_source),
...
class NestedUpdateMixin(BaseNestedModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        # Update instance
        instance = super(NestedUpdateMixin, self).update(instance, validated_data,)
        self.update_or_create_reverse_relations(instance, reverse_relations)
        ...
        for (
            ...
            try:
                ...
                self.fail(
                    ...
                    instances=", ".join([str(instance) for instance in instances]),
                )
